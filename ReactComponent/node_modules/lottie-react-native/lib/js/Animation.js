...
class LottieAnimation extends React.Component {
  ...
  // 添加带动画结束回调API ---add by shaolin
  playWithCompleteCallcack(completeCallcack) {
      LottieViewManager.playWithCompleteCallcack(this.getHandle(),completeCallcack);
  }
...
// 添加带动画结束回调API ---add by shaolin
Animation.prototype.playWithCompleteCallcack = function playWithCompleteCallcack(completeCallcack) {
    return this.getNode().playWithCompleteCallcack(completeCallcack);
}
